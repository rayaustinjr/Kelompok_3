...
WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/AcceptOffer/Click button terima'), [('productName') : randomProductName], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('null'), [('productName') : randomProductName], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/Reject Offer/Click Perbaharui Status Penjualan (Tolak)'), [:], 
    FailureHandling.STOP_ON_FAILURE)

//WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/Reject Offer/Verify status offer'), [('status') : 'Penjualan dibatalkan'
