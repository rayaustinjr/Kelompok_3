...
WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/AcceptOffer/Select Product Name'), [('productName') : ''], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/Reject Offer/Click button Tolak'), [('productName') : randomProductName], 
    FailureHandling.STOP_ON_FAILURE)

//WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/Reject Offer/Verify status offer'), [('productName') : randomProductName
//  , ('status') : 'Penawaran produk ditolak'], FailureHandling.STOP_ON_FAILURE)
WebUI.delay(5)
