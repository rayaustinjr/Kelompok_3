...
WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/OfferProduct/Input Field harga Tawar'), [('offerPrice') : 'eee'], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/OfferProduct/Click button Kirim'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Feature 4 - Mariati/OfferProduct/Verify get attribute Offer'), [('message') : '', ('Expected') : 'Please enter a valid value. The two nearest valid values are 0 and 1.'], 
    FailureHandling.STOP_ON_FAILURE)
