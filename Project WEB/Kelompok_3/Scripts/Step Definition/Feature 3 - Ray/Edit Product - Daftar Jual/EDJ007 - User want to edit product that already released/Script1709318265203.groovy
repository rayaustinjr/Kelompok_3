...
WebUI.callTestCase(findTestCase('Pages/Feature 3 - Ray/Edit Product - Daftar Jual/Edit Product'), [('productName') : 'Kondangan', ('productPrice') : '100000'
        , ('productCategory') : 'Hobi', ('description') : 'Foto Kondangan'], FailureHandling.STOP_ON_FAILURE)
