...
WebUI.callTestCase(findTestCase('Pages/Feature 1 - Shinta/Complete Profile/Select City'), [('City') : 'Jakarta'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Feature 1 - Shinta/Complete Profile/Input Phone Number'), [('NoHP') : NoHP], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Feature 1 - Shinta/Complete Profile/Verify Invalid Format for Phone Number'), [('message') : ''
        , ('expected') : 'Format number is invalid'], FailureHandling.STOP_ON_FAILURE)
